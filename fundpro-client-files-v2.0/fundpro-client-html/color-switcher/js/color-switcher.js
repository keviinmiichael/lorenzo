...
jQuery(document).ready(function($) {
    ...
    $('#switcher-layout-mode a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-colored btn-dark').addClass('btn btn-border btn-theme-colored');
        var layout_mode = $(this).removeClass('btn btn-border btn-theme-colored').addClass('btn btn-theme-colored btn-dark').data('layout-mode');
        if( layout_mode == "wide" ) {
            $('body').removeClass('boxed-layout').removeClass('pt-40').removeClass('pb-40');
        } else if( layout_mode == "boxed" ) {
            $('body').addClass('boxed-layout bg-silver-light pt-40 pb-40 p-sm-0');
    ...
    $('#switcher-bgcolor a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-colored btn-dark').addClass('btn btn-border btn-theme-colored');
        var bgcolor = $(this).removeClass('btn btn-border btn-theme-colored').addClass('btn btn-theme-colored btn-dark').data('bgcolor-type');
        if( bgcolor == "dark" ) {
            $('body').addClass('dark');
    ...
    $('#switcher-rtl a').on('click', function(e) {
        $(this).parent().find('a').removeClass('btn btn-theme-colored btn-dark').addClass('btn btn-border btn-theme-colored');
        var direction_type = $(this).removeClass('btn btn-border btn-theme-colored').addClass('btn btn-theme-colored btn-dark').data('direction-type');
